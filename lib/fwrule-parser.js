...
lexer.rules = [/^\s+/,/^$/,/^[Ff][Rr][Oo][Mm]/,/^[Tt][Oo]/,/^ip\b/,/^subnet\b/,/^any\b/,/^all\b/,/^tag\b/,/^machine\b/,/^\(/,/^\)/,/^OR\b/,/^[Aa][Nn][Dd]/,/^[Bb][Ll][Oo][Cc][Kk]/,/^[Aa][Ll][Ll][Oo][Ww]/,/^[Pp][Oo][Rr][Tt]/,/^[Tt][Cc][Pp]/,/^[Uu][Dd][Pp]/,/^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}/,/^\/[0-9][0-9]/,/^[-a-zA-Z0-9_]+/];
...
exports.parser = fwruleParser;
exports.parse = function () { return fwruleParser.parse.apply(fwruleParser, arguments); }
