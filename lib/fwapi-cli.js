...
FwapiCLI.prototype.do_update = function (subcmd, opts, args, callback) {
  ...
  cli.getPayload(opts, args, function (err, payload) {
    ...
    return self.fwapi.updateRule(id, payload, standardHandler.bind(null, opts));
  });
};
...
FwapiCLI.prototype.do_enable = function () { enableDisable.apply(this, arguments) };
FwapiCLI.prototype.do_enable.help = 'Enable a rule.';

FwapiCLI.prototype.do_disable = function () { enableDisable.apply(this, arguments) };
